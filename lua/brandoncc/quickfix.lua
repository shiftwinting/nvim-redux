...
map('n', '<C-q>', "<cmd>lua require('brandoncc.quickfix').toggle(1)<CR>", { noremap = true, silent = true });
map('n', '<Leader>q', "<cmd>lua require('brandoncc.quickfix').toggle(0)<CR>", { noremap = true, silent = true });
